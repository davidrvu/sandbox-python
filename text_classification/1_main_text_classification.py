# SOURCE: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/learn/text_classification_character_rnn.py
...
def main(unused_argv):
  ...
  print("pandas.Series ... ")
  x_train = pandas.Series(dbpedia.train.data[:,1]) # FEATURES
  y_train = pandas.Series(dbpedia.train.target)    # LABELS
  x_test  = pandas.Series(dbpedia.test.data[:,1])  # FEATURES
  y_test  = pandas.Series(dbpedia.test.target)     # LABELS
