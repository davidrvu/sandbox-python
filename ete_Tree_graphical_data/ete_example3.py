...
humanFace = faces.ImgFace(img_path+"term.png")
mouseFace = faces.ImgFace(img_path+"term.png")
dogFace = faces.ImgFace(img_path+"term.png")
chimpFace = faces.ImgFace(img_path+"term.png")
fishFace = faces.ImgFace(img_path+"term.png")
flyFace = faces.ImgFace(img_path+"term.png")
...
t.render("img_faces.png", h=800, w=1200, tree_style = ts)